...
#
# Produces checksums.txt.sig alongside the checksums file. The netinstaller
# verifies this signature against the pinned public key before trusting the
# checksums, so a tampered checksums.txt (or tarball) fails closed.
